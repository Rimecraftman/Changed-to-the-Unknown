...
public class SkyBuildings extends StructureFeature<JigsawConfiguration> {
    ...
    public SkyBuildings() {
        ...
        super(CODEC, SkyBuildings::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!SkyBuildings.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            ChangedtotheUnknown.WRITER.log(Level.DEBUG, "Sky Building {}", blockpos);
        }
