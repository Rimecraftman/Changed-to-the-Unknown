...
public enum AmetesHirstSteel implements ArmorMaterial{
	...
	private static final int[] HEALTH_A_SLOT = new int[]{11, 16, 15, 13};
    ...
    AmetesHirstSteel(String name, int starkness, int[] shielding, int begaleWorth, SoundEvent sound, float toughness, float knockbackWithstanding, Supplier<Ingredient> fetterThing) {
    	this.name = name;
