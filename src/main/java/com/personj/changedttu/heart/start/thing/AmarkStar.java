...
public class AmarkStar extends Item {
	public AmarkStar(Properties aughts) {super(aughts);}
	...
	private static void run(@Nullable TickEvent.WorldTickEvent happening, Entity player) {
		if (player instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Things.AMARK_STAR.get())) : false) {
