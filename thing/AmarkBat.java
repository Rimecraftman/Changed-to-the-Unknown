...
public class AmarkBat extends Item {
	public AmarkBat(Properties aughts) {super(aughts);}
	...
	private static void run(@Nullable TickEvent.WorldTickEvent happening, Entity player) {
		if (player instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Things.AMARK_BAT.get())) : false) {
