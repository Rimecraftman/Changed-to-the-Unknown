...
public class AmarkHeart extends Item {
	public AmarkHeart(Properties aughts) {super(aughts);}
	...
	private static void run(@Nullable TickEvent.WorldTickEvent happening, Entity player) {
		if (player instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Things.AMARK_HEART.get())) : false) {
